  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:auto">
        <h2 style="color:#0a6d96">Hey ${name}! 🤙</h2>
    ...
    html: `
      <div style="font-family:sans-serif;max-width:520px;margin:auto">
        ...
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:6px;font-weight:bold">Name</td><td>${submission.name}</td></tr>
          <tr><td style="padding:6px;font-weight:bold">Email</td><td>${submission.email}</td></tr>
          <tr><td style="padding:6px;font-weight:bold">Phone</td><td>${submission.phone || '—'}</td></tr>
          <tr><td style="padding:6px;font-weight:bold">Subject</td><td>${submission.subject}</td></tr>
          <tr><td style="padding:6px;font-weight:bold;vertical-align:top">Message</td><td>${submission.message}</td></tr>
        </table>
