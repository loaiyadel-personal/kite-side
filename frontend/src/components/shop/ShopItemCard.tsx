...
export default function ShopItemCard({ item }: Props) {
  ...
  return (
    <div className={[
      ...
      'hover:-translate-y-1 hover:shadow-xl hover:border-[#1a9fd4]/40',
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        <div className="flex-1">
          <h3 className="font-outfit font-bold text-[#022b3d] text-base leading-snug mb-1">
            {item.name}
          </h3>
          {item.description && (
        ...
        {/* Price */}
        <div>
          <p className="font-outfit font-bold text-2xl text-[#1a9fd4]">
        ...
        <div className="flex flex-col gap-2">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-[#1a9fd4] text-white text-sm font-semibold hover:bg-[#1589b8] transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-full py-2.5 rounded-xl border border-[#1a9fd4] text-[#1a9fd4] text-sm font-semibold hover:bg-[#1a9fd4]/5 transition-colors"
          >
            Ask a Question
          </a>
        </div>
